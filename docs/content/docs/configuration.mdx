---
title: Configuration
description: Complete reference for the railguard.toml configuration file.
---

Railguard is configured via a TOML file, typically named `railguard.toml`.

## Config File Location

Railguard searches for configuration in this order:
