---
title: Introduction
description: Railgun is a Claude Code hook that protects against secrets leakage, dangerous commands, and unauthorized tool use.
---
...
- [Getting Started](/docs/getting-started) — Install and configure Railgun
- [Configuration](/docs/configuration) — Write your `railgun.toml` policy
